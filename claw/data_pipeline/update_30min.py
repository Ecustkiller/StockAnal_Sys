...
DATA_DIR = '/Users/ecustkiller/Downloads/2026/30min'
...
print(f"30min更新: 共{total}只, 目标日期{TODAY}")
...
for i, fp in enumerate(files):
    ...
    while retry < 2:
        try:
            df = get_price(code, frequency='30m', count=100)
...
print(f"\n30min汇总: 共{total}只 | 更新{updated}只(+{total_rows}条) | 已最新{uptodate} | 错误{errors}")
if err_list:
